...
public:                                                               // main overloads
    ...
    virtual void print(const BlockStringView &text) noexcept = 0;     ///< Print terminal text.
    virtual void print(const text::StringView &text) noexcept = 0;    ///< Print UTF-8 text.
    virtual void print(const text::U32StringView &text) noexcept = 0; ///< Print UTF-32 text.
...
public:
    ...
    void print(const text::String &text) noexcept { ///< Print UTF-8 text.
        print(text::StringView{text});
    }
    void print(const text::U32String &text) noexcept { ///< Print UTF-32 text.
        print(text::U32StringView{text});
    }
