...
auto createStreamDemoDirectory(const el::String &prefix) -> el::TempDirectoryPtr {
...
auto bytesFromText(const el::String &text) -> el::ByteBlock {
    return el::StringEncoder{text}.encode(el::StringEncoding::Utf8);
}
