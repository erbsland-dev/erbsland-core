...
See :doc:`/topics/text_formatting/building_strings` for the allocation differences between ``String::fromJoined()``,
``StringList::join()``, a reserved editor, and ``AnyStringBuilder``.
