    ...
    def test_transform_rewrites_only_generated_cpp_index_entries(self) -> None:
        ...
        index_node = addnodes.index(
            entries=[
                ...
                (
                    "single",
                    "erbsland::geometry::Alignment::~Alignment (C++ function)",
                    "_CPPv4N8erbsland8geometry9AlignmentD0Ev",
                    "",
                    None,
                ),
                (
                    "single",
                    "erbsland::geometry::Alignment::Alignment (C++ function)",
                    "_CPPv4N8erbsland8geometry9Alignment9AlignmentEv",
                    "",
                    None,
                ),
                (
                ...
                (
                    "single",
                    "erbsland::geometry::Alignment::Bottom (C++ member)",
                    "_CPPv4N8erbsland8geometry9Alignment6BottomE",
                    "",
                    None,
                ),
        ...
        self.assertEqual(
            [
                ...
                ("single", "Bottom; Alignment", "_CPPv4N8erbsland8geometry9Alignment6BottomE", "", None),
                ("single", "erbsland::text::Manual (C++ type)", "index-0", "", None),
                ("single", "std::string (C++ class)", "_CPPv4NSt6stringE", "", None),
                ("pair", "erbsland::text::Pair (C++ type); pair", "_CPPv4N8erbsland4text4PairE", "", None),
            ],
