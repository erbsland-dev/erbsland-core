...
#include "../tcp/TcpConnectionCloseContext.hpp"
...
private:
    ...
    void finishClosed(TcpConnectionCloseOrigin origin);
    ...
    void postClosedAndFinal(std::uint64_t generation, TcpConnectionCloseContext context);
...
private:
    ...
    std::optional<TcpConnectionCloseOrigin> _closeOrigin;                 ///< First normal-close initiator.
    ...
    TcpConnectionCloseFn _onClosed;                                       ///< Normal-close handler.
