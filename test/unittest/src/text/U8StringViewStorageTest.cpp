...
#include <erbsland/text/u8/impl/U8StringViewStorage.hpp>
#include <erbsland/unittest/UnitTest.hpp>

#include <string_view>
#include <variant>

TESTED_TARGETS(U8StringViewStorage)
class U8StringViewStorageTest final : public el::UnitTest {
public:
    void testVariantAlternatives() {
        auto storage = el::text::impl::U8StringViewStorage{};
