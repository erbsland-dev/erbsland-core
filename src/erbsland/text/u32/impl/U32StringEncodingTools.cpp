...
auto U32StringEncodingTools::encodeUtf8(const std::span<const char32_t> data, const StringBomMode bomMode)
    -> ByteBlock {
    ...
    utf32::forEachDecodedCharacter(
        data, EncodingMode::Tolerant, [&](const Char character) -> void { u8Writer.write(character); });
    return writer.toByteBlock();
}

auto U32StringEncodingTools::encodeUtf16(
    const std::span<const char32_t> data, const StringEncoding encoding, const StringBomMode bomMode) -> ByteBlock {
    auto writer = ByteWriter{};
    ...
    utf32::forEachDecodedCharacter(
        data, EncodingMode::Tolerant, [&](const Char character) -> void { u16Writer.write(character); });
    return writer.toByteBlock();
}
...
auto U32StringEncodingTools::encodeUtf32(
    ...
    utf32::forEachDecodedCharacter(
        data, EncodingMode::Tolerant, [&](const Char character) -> void { u32Writer.write(character); });
    return writer.toByteBlock();
}
...
auto U32StringEncodingTools::decodeUtf8(const ByteBlock &data, const DecodeLayout layout, const EncodingMode mode)
    -> U32StringEditor {
    switch (mode) {
...
auto U32StringEncodingTools::decodeUtf16(const ByteBlock &data, const DecodeLayout layout, const EncodingMode mode)
    -> U32StringEditor {
    switch (mode) {
    case EncodingMode::Strict:
        return decodeFromCharacters([&](auto function) -> void {
...
auto U32StringEncodingTools::decodeUtf32(const ByteBlock &data, const DecodeLayout layout, const EncodingMode mode)
    -> U32StringEditor {
    switch (mode) {
    case EncodingMode::Strict:
        return decodeFromCharacters([&](auto function) -> void {
...
auto U32StringEncodingTools::encode(const StringEncoding encoding, const StringBomMode bomMode) const -> ByteBlock {
...
auto U32StringEncodingTools::encodedLength(const StringEncoding encoding, const StringBomMode bomMode) const
    -> unit::ByteLength {
    auto result = encoding.bomLength(bomMode);
    utf32::forEachDecodedCharacter(_data.dataSpan(), EncodingMode::Tolerant, [&](const Char character) -> void {
...
auto U32StringEncodingTools::encodeTo(
    ...
    utf32::forEachDecodedCharacter(
        _data.dataSpan(), EncodingMode::Tolerant, [&](const Char character) -> void { writer.write(character); });
