...
/// The grammar and key table for `NamedKeyParser`.
/// @tested{NamedKeyParserTest}
class NamedKeyFormat final {
public:
...
public:
    ...
    NamedKeyFormat() = default;

    // defaults
    ~NamedKeyFormat() = default;
    NamedKeyFormat(const NamedKeyFormat &) = default;
    NamedKeyFormat(NamedKeyFormat &&) = default;
    auto operator=(const NamedKeyFormat &) -> NamedKeyFormat & = default;
    auto operator=(NamedKeyFormat &&) -> NamedKeyFormat & = default;

public: // key table
    /// Replace all key aliases.
    auto setKeys(std::initializer_list<Key> keys) -> NamedKeyFormat &;
    /// @overload
    auto setKeys(Keys keys) -> NamedKeyFormat &;
    /// Add one key alias.
    auto addKey(String name, int index) -> NamedKeyFormat &;
...
public: // policy
    ...
    auto setUniqueKeysRequired(bool enabled) noexcept -> NamedKeyFormat &;
    ...
    auto setKeysWithoutValuesAllowed(bool enabled) noexcept -> NamedKeyFormat &;
    ...
    auto setValuesAllowed(bool enabled) noexcept -> NamedKeyFormat &;
    ...
    auto setValueListAllowed(bool enabled) noexcept -> NamedKeyFormat &;
...
public: // syntax
    ...
    auto setListSeparator(Char separator) noexcept -> NamedKeyFormat &;
    ...
    auto setValueSeparator(Char separator) noexcept -> NamedKeyFormat &;
    ...
    auto setStopCharacter(Char character) noexcept -> NamedKeyFormat &;
    ...
    auto setAllowedKeyPrefixes(CharSet characters) noexcept -> NamedKeyFormat &;
    ...
    auto setAllowedValueChars(CharSet characters) noexcept -> NamedKeyFormat &;
    ...
    auto setValueWithoutKeySeparatorChars(CharSet characters) noexcept -> NamedKeyFormat &;
