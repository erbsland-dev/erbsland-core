...
A string has more than one meaningful notion of size and identity.
Its native encoded length may differ from its number of decoded code points, and two values with identical text may or
may not refer to the same backing storage.
Even a question as simple as “is this valid text?” has a different cost from asking whether the value is empty.

This page helps you choose the attribute that answers the question you actually have.
It uses the common UTF-8 :cpp:type:`String <erbsland::text::String>` in its examples, but the same model applies to the
UTF-16 and UTF-32 families, their editors, and literals.
The table gives you a quick view of the costs before the following sections explore why they differ.
...
Empty Text and Well-formed Encodings
====================================

Use :cpp:func:`isEmpty() <erbsland::text::U8String::isEmpty>` when you need to know whether a string contains any stored
data.
...
.. erbsland-demo::
    ...
    :source-sha256: b8e110c4c5fc8b4de086a108edf6b0d85ace79b6c4fa3d340c00a5bf3f9a2115
...
Two Lengths That Answer Different Questions
===========================================
...
.. erbsland-demo::
    ...
    :source-sha256: 73d229f853967305ee327d284a8fd32aba0639f70e2fc0934e511a7501901cc2
...
Hash the Text, Not Its Encoding
===============================
...
.. erbsland-demo::
    ...
    :source-sha256: 159dd54576c1a02a15a9db0a56a7a613a910c9f2c87ba76c5e4db4b9889ac77c
...
Know Whether a Position Belongs to This Storage
===============================================
