...
public: // view key access
    ...
    auto remove(const View &key) -> StringHashMap & {
    ...
    [[nodiscard]] auto removed(const View &key) const -> StringHashMap {
        auto result = *this;
        result.remove(key);
        return result;
    }
    ...
    auto set(const View &key, const tValue &value) -> StringHashMap & {
