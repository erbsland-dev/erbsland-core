...
auto StringInput::createMatch(ConstRegExPtr regEx, CaptureGroupList captureGroupList) -> MatchPtr {
    ...
    return std::make_shared<StringMatch>(std::move(regEx), std::move(captureGroupList), _text);
}
