...
void DisplayTextMap::addDefaultTexts() {
    set("UnknownError"_el, "Unknown Error"_el)
        ...
        .set("options.DidYouMeanHeading"_el, "Did You Mean"_el)
        .set("options.DescriptionHeading"_el, "Description"_el)
        .set("options.ExampleHeading"_el, "Example"_el)
        .set("options.SeeAlsoHeading"_el, "See Also"_el)
