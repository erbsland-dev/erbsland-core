...
syntax.
Use :doc:`format_specifications` for new application-owned patterns, especially when a field should enforce its value
type; use this page when maintaining or translating compact specifications.
