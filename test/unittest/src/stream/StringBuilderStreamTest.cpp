...
public:
    void testConstructionAndEncoding() {
        const auto u8Stream = el::stream::StringBuilderStream::create(StringKind::U8);
        const auto u16Stream = el::stream::StringBuilderStream::create(StringKind::U16);
        const auto u32Stream = el::stream::StringBuilderStream::create(StringKind::U32);
    ...
    void testWriteMethodsAndClear() {
        ...
        auto stream = el::stream::StringBuilderStream::create(StringKind::U16);
    ...
    void testPrintWritesThroughBuilderContext() {
        auto stream = el::stream::StringBuilderStream::create(StringKind::U32);
    ...
    void testPrintByteBlocks() {
        auto stream = el::stream::StringBuilderStream::create(StringKind::U8);
    ...
    void testFlushAndCloseState() {
        ...
        REQUIRE_THROWS(stream->writeLine(String{std::string_view{"closed"}}));
