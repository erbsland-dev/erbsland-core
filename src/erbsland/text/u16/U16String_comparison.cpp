...
auto U16String::compare(const U16StringView &other, const CharCompareFn compareFn) const noexcept
    -> std::strong_ordering {
    return impl::U16StringComparisonTools{dataView()}.compare(other.dataView(), compareFn);
}

auto U16String::operator<=>(const U16StringView &other) const noexcept -> std::strong_ordering {
    return compare(other);
}

auto U16String::startsWith(const U16StringView &other, const CharCompareFn compareFn) const noexcept -> bool {
    return impl::U16StringComparisonTools{dataView()}.startsWith(other.dataView(), compareFn);
}

auto U16String::endsWith(const U16StringView &other, const CharCompareFn compareFn) const noexcept -> bool {
    return impl::U16StringComparisonTools{dataView()}.endsWith(other.dataView(), compareFn);
}

auto U16String::contains(const U16StringView &other, const CharCompareFn compareFn) const noexcept -> bool {
    return impl::U16StringComparisonTools{dataView()}.contains(other.dataView(), compareFn);
}

auto U16String::count(const U16StringView &text, const CharCompareFn compareFn) const noexcept -> unit::ElementCount {
