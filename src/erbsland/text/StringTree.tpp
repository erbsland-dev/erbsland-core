...
auto StringTree::append(StringView label, const T value, const IntegerFormat format) -> StringTree & {
...
auto StringTree::appendList(StringView label, Range &&range, Convert convert) -> StringTree & {
