...
public:
    ...
    /// Serialize an HTTP origin-form request target without a fragment.
    [[nodiscard]] auto writeRequestTarget() -> text::String;
    /// Serialize the HTTP Host field value.
    [[nodiscard]] auto writeHostField() -> text::String;
