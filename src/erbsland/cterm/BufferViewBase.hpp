...
public:
    ...
    explicit BufferViewBase(const block::Rectangle viewRectangle) noexcept : _viewRect{viewRectangle} {}
...
public:
    ...
    [[nodiscard]] auto viewRect() const noexcept -> const block::Rectangle &;
    ...
    [[nodiscard]] auto cropCharacter(block::Direction direction) const noexcept -> Block;
    ...
    void setCropCharacter(block::Direction direction, Block character) noexcept;

protected:
    block::Rectangle _viewRect{0, 0, 1, 1};
    bool _showCropCharacters = false;
    std::array<Block, block::Direction::cCount> _cropCharacters{
        Block{U' '},
        Block{U'▲'},
        Block{U'◥'},
        Block{U'▶'},
