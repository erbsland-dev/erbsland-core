...
auto U8String::compare(const U8String &other, const CharCompareFn compareFn) const noexcept -> std::strong_ordering {
    return impl::U8StringComparisonTools{dataView()}.compare(other.dataView(), compareFn);
}

auto U8String::operator<=>(const U8String &other) const noexcept -> std::strong_ordering {
    return compare(other);
}

auto U8String::startsWith(const U8String &other, const CharCompareFn compareFn) const noexcept -> bool {
    return impl::U8StringComparisonTools{dataView()}.startsWith(other.dataView(), compareFn);
}

auto U8String::endsWith(const U8String &other, const CharCompareFn compareFn) const noexcept -> bool {
    return impl::U8StringComparisonTools{dataView()}.endsWith(other.dataView(), compareFn);
}

auto U8String::contains(const U8String &other, const CharCompareFn compareFn) const noexcept -> bool {
