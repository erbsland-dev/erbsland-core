...
void alignAndTruncate() {
    ...
    const auto observation = el::String{"Observation: Alpenrose beside pale limestone under morning light"_el};
    ...
    auto mutableObservation = el::StringEditor{observation};
