...
template <typename tKey, typename tValue, typename tHash, typename tEqual, typename tSelf>
    ...
    std::copyable<tValue>
auto HashMap<tKey, tValue, tHash, tEqual, tSelf>::take(const Key &key) -> Value {
...
auto HashMap<tKey, tValue, tHash, tEqual, tSelf>::takeIf(Function function) -> Self {
    auto &data = mutableRaw();
    auto taken = Raw{};
...
template <typename tKey, typename tValue, typename tHash, typename tEqual, typename tSelf>
    ...
    std::copyable<tValue>
template <typename Function>
auto HashMap<tKey, tValue, tHash, tEqual, tSelf>::takeIfKey(Function function) -> Self {
...
template <typename tKey, typename tValue, typename tHash, typename tEqual, typename tSelf>
    ...
    std::copyable<tValue>
template <typename Function>
auto HashMap<tKey, tValue, tHash, tEqual, tSelf>::takeIfValue(Function function) -> Self {
