...
auto U8StringEditor::fromFloat(const double value, const FloatFormat format) -> U8StringEditor {
    const auto text = impl::formatFloat(value, format);
    return U8StringEditor{text};
}

template <impl::AnyFloatType T>
auto U8StringEditor::toFloat(T defaultValue, FloatParseOptions options) const noexcept -> T {
...
template <impl::AnyFloatType T>
auto U8StringEditor::toFloatOrThrow(FloatParseOptions options) const -> T {
    if constexpr (std::same_as<T, float>) {
...
template auto U8StringEditor::toFloat<float>(float defaultValue, FloatParseOptions options) const noexcept -> float;
template auto U8StringEditor::toFloat<double>(double defaultValue, FloatParseOptions options) const noexcept -> double;
template auto U8StringEditor::toFloatOrThrow<float>(FloatParseOptions options) const -> float;
template auto U8StringEditor::toFloatOrThrow<double>(FloatParseOptions options) const -> double;
