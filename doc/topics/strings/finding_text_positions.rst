...
For :cpp:type:`StringView <erbsland::text::StringView>`, these positions are byte indexes.
You can pass them directly to :cpp:func:`slice() <erbsland::text::U8StringView::slice>`, continue searching from them,
or move them with :cpp:func:`advance() <erbsland::text::U8StringView::advance>` and
:cpp:func:`retreat() <erbsland::text::U8StringView::retreat>` when a result must be shifted by decoded characters.
...
:cpp:func:`charAt(ByteIndex) <erbsland::text::U8StringView::charAt>`.
...
:cpp:func:`retreat() <erbsland::text::U8StringView::retreat>` to move by decoded characters.
...
Use :cpp:func:`findFirstOf() <erbsland::text::U8StringView::findFirstOf>` to find the next token start, then
:cpp:func:`findFirstNotOf() <erbsland::text::U8StringView::findFirstNotOf>` to find its end.

The end position may be missing when the final token reaches the end of the string.
In that case, use :cpp:func:`indexAt(StringSide::Back) <erbsland::text::U8StringView::indexAt>` as the end position.
...
:cpp:func:`find() <erbsland::text::U8StringView::find>` searches for a complete string.
...
*   Move past the boundary with :cpp:func:`advance() <erbsland::text::U8StringView::advance>` if the boundary itself
    should be excluded.
...
:cpp:func:`indexAt(StringSide::Back) <erbsland::text::U8StringView::indexAt>` or an infinite
