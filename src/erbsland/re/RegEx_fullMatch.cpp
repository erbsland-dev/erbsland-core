...
auto RegEx::fullMatch(const text::StringView &text) const -> MatchPtr {
    return fullMatch(impl::StringInput::create(text));
}

auto RegEx::fullMatch(const text::U16StringView &text) const -> Match16Ptr {
    return fullMatch(impl::U16StringInput::create(text));
}

auto RegEx::fullMatch(const text::U32StringView &text) const -> Match32Ptr {
