...
public:
    ...
    /// @return `true` for `BackPressure`.
    [[nodiscard]] auto hasBackPressure() const noexcept -> bool { return *this == BackPressure; }
...
public:
    ...
    static const NetworkSendStatus BackPressure; ///< The send queue currently has insufficient capacity.
...
inline constexpr NetworkSendStatus NetworkSendStatus::BackPressure = NetworkSendStatus::Value::failure<0>();
