...
public: // accessors
    ...
    [[nodiscard]] auto offeredAlpn() const noexcept -> const std::vector<mem::ByteBlock> & { return _offeredAlpn; }
    /// Get the selected ALPN identifier, or an empty block when none was negotiated.
    [[nodiscard]] auto negotiatedAlpn() const noexcept -> const mem::ByteBlock & { return _negotiatedAlpn; }
...
private:
    ...
    std::vector<mem::ByteBlock> _offeredAlpn;                         ///< Bounded ALPN offer in client order.
    mem::ByteBlock _negotiatedAlpn;                                   ///< Selected ALPN protocol.
