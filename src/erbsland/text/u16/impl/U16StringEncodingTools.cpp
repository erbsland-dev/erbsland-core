...
auto U16StringEncodingTools::encodeUtf16(
    const std::span<const char16_t> data, const StringEncoding encoding, const StringBomMode bomMode)
    -> mem::ByteBlock {
    auto writer = mem::ByteWriter{};
...
auto U16StringEncodingTools::encode(const StringEncoding encoding, const StringBomMode bomMode) const
    -> mem::ByteBlock {
    switch (encoding) {
