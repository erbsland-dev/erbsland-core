...
See :doc:`editing_strings_in_place` for that workflow.
...
If the goal is construction from fragments, use the allocation-aware choices in :doc:`building_strings` instead.
...
Read :doc:`normalizing_strings` before comparing or storing canonically equivalent text.
