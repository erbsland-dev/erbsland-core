...
public:
    ...
    explicit StreamError(text::StringView reason) noexcept : Exception{std::move(reason)} {}
    /// @overload
    explicit StreamError(const std::string_view reason) noexcept : Exception{reason} {}
};
