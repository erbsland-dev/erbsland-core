...
public:
    ...
    auto createTerminal(
        const std::shared_ptr<TerminalTestBackend> &backend, const block::Size size = block::Size{80, 25})
    ...
    auto createMinimumSizeWarningSettings(const block::Size minimumSize, const erbsland::text::String &message)
        -> UpdateSettings {
