...
/// Application metadata used by option renderers.
/// @tested{StandardOptionRendererTest}
class OptionDisplayInfo {
public:
    OptionDisplayInfo() = default;
    ~OptionDisplayInfo() = default;
    OptionDisplayInfo(const OptionDisplayInfo &) = default;
    auto operator=(const OptionDisplayInfo &) -> OptionDisplayInfo & = default;
    OptionDisplayInfo(OptionDisplayInfo &&) = default;
    auto operator=(OptionDisplayInfo &&) -> OptionDisplayInfo & = default;
