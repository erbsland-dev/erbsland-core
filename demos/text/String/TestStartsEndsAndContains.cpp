...
/// This demo shows how to easily test if a read-only string starts, ends, or contains a specific substring.
void testStartsEndsAndContains() {
    // Creating named strings is only for this demo; use literals directly in production code.
    const auto thePond = el::String{"古池や 蛙飛びこむ 水の音"_el};
    const auto flowers = el::String{"İstanbul ormanında Işık ve çiçekler"_el};
