...
public:
    void testStorageIdentifier() {
        const auto text = U8String{std::string_view{"abcd"}};
        const auto whole = text.storageId();
        const auto wholeView = U8StringView{text}.storageId();
    ...
    void testReadUtf8StringAndView() {
        ...
        auto viewReader = StringCharReader{U8StringView{sliced}};
    ...
    void testReadUtf16StringAndView() {
        ...
        auto viewReader = StringCharReader{U16StringView{sliced}};
    ...
    void testReadUtf32StringAndView() {
        ...
        auto viewReader = StringCharReader{U32StringView{sliced}};
    ...
    void testReadLoopCallbackStopsLeaveCharacterUnread() {
        ...
        WITH_CONTEXT(requireReadLoopCallbackResult(
            ...
            CpIndex{2U}));
        WITH_CONTEXT(requireReadLoopCallbackResult(
            StringCharReader{U16String{std::u16string_view{u"A\U0001F600B!"}}},
            Char{U'\U0001F600'},
            LoopStatus::Stop,
            LoopResult::Stopped,
            CpIndex{1U}));
        WITH_CONTEXT(requireReadLoopCallbackResult(
            ...
            CpIndex{1U}));
        WITH_CONTEXT(requireReadLoopCallbackResult(
            StringCharReader{U32String{std::u32string_view{U"xy€?"}}},
            Char{U'\u20AC'},
            LoopStatus::Stop,
            LoopResult::Stopped,
            CpIndex{2U}));
    ...
    void testReadLoopEndOfDataAndZeroLimit() {
        ...
        auto untilEndReader = StringCharReader{U32String{std::u32string_view{U"xy"}}};
        ...
        auto zeroLimitEndReader = StringCharReader{U8String{}};
        REQUIRE_EQUAL(
    ...
    void testRestoreRejectsWrongKindAndOutOfRange() {
        const auto longText = U8String{std::string_view{"abcd"}};
        ...
        auto shortUtf8Reader = StringCharReader{U8String{std::string_view{"a"}}};
        ...
        auto utf16Reader = StringCharReader{U16String{std::u16string_view{u"abc"}}};
        REQUIRE(utf16Reader.advance());
        const auto utf16State = utf16Reader.save();

        auto utf32Reader = StringCharReader{U32String{std::u32string_view{U"abc"}}};
        REQUIRE_FALSE(utf32Reader.restore(utf16State));
        REQUIRE_EQUAL(utf32Reader.read().toRawValue(), U'a');
    }

    void testParseIntegerBasics() {
        auto decimalReader = StringCharReader{U8String{std::string_view{"123abc"}}};
        ...
        auto hexadecimalReader = StringCharReader{U8String{std::string_view{"1fZ"}}};
        ...
        auto noDigitsReader = StringCharReader{U8String{std::string_view{"abc"}}};
        ...
        auto tooManyDigitsReader = StringCharReader{U8String{std::string_view{"1234"}}};
        ...
        auto overflowReader = StringCharReader{U8String{std::string_view{"18446744073709551616"}}};
    ...
    void testParseIntegerSignsAndPrefixes() {
        auto negativeHexReader = StringCharReader{U8String{std::string_view{"-0x1f!"}}};
        ...
        auto plusReader = StringCharReader{U8String{std::string_view{"+123"}}};
        ...
        auto rejectedPlusReader = StringCharReader{U8String{std::string_view{"+123"}}};
        ...
        auto rejectedMinusReader = StringCharReader{U8String{std::string_view{"-123"}}};
        ...
        auto fixedBasePrefixReader = StringCharReader{U8String{std::string_view{"0xff"}}};
    ...
    void testParseIntegerDigitModes() {
        auto limitedReader = StringCharReader{U8String{std::string_view{"1234"}}};
        ...
        auto fixedReader = StringCharReader{U8String{std::string_view{"1234"}}};
        ...
        auto tooFewReader = StringCharReader{U8String{std::string_view{"12x"}}};
    ...
    void testParseIntegerSeparators() {
        auto separatedReader = StringCharReader{U8String{std::string_view{"1_234x"}}};
        ...
        auto leadingReader = StringCharReader{U8String{std::string_view{"_123"}}};
        ...
        auto trailingReader = StringCharReader{U8String{std::string_view{"123_"}}};
        ...
        auto doubledReader = StringCharReader{U8String{std::string_view{"12__3"}}};
        ...
        auto tooManyReader = StringCharReader{U8String{std::string_view{"12_3"}}};
    ...
    void testReadIntegerOrThrow() {
        ...
        auto signedReader = StringCharReader{U8String{std::string_view{"-128!"}}};
        ...
        auto fixedDecimalReader = StringCharReader{U8String{std::string_view{"2026-06-05"}}};
        REQUIRE_EQUAL(
        ...
        auto fixedHexReader = StringCharReader{U8String{std::string_view{"ff:"}}};
        REQUIRE_EQUAL(
    ...
    void testReadIntegerOrThrow2() {
        auto targetOverflowReader = StringCharReader{U8String{std::string_view{"128!"}}};
        try {
            static_cast<void>(
    ...
    void testReadIntegerOrThrow3() {
        auto unsignedNegativeReader = StringCharReader{U8String{std::string_view{"-1!"}}};
        try {
            auto signedOptions = integerOptions(IntegerBase::Decimal);
            signedOptions.addFlags(IntegerParseFlag::AcceptMinusSign);
    ...
    void testReadIntegerOrThrow4() {
        auto invalidReader = StringCharReader{U8String{std::string_view{th::stdStringFromHex("31 C0 32")}}};
        try {
            static_cast<void>(
...
private:
    ...
    void requireCapture(const AnyStringView &capture, StringKind expectedKind, std::u32string_view expectedText) {
    ...
    void requireReadIntegerNumberError(
        ...
        auto reader = StringCharReader{U8String{text}};
        try {
